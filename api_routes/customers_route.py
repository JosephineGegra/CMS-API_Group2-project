...
@customer_route.post("/", response_model=Schema.Customer)
...
@customer_route.get("/", response_model=list[Schema.Customer])
def get_all_customers(db: Session = Depends(get_db),
                      current_user: models.User = Depends(get_current_user)
):
    return customer_service.get_all_customers(db)

@customer_route.get("/{customer_id}", response_model=Schema.Customer)
...
@customer_route.put("/{customer_id}", response_model=Schema.Customer)
